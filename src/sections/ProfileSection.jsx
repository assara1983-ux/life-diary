      ...
      {activeTab === 'main' && (
        <>
          ...
          <FlipCardBlock 
             ...
             frontImage={getFrontImage("western", insights.zodiac)} 
             accentColor="var(--blue)"
             frontContent={
          ...
          <FlipCardBlock 
             ...
             frontImage={getFrontImage("eastern", insights.eastern)} 
          ...
          <FlipCardBlock 
             title="Градус Судьбы" 
             frontImage={getFrontImage("destiny")} 
             accentColor="var(--gold)"
             frontContent={
          ...
          <FlipCardBlock 
             title="Хроно-тип" 
             frontImage={getFrontImage("chrono", profile.chronotype)} 
             accentColor="var(--blue)"
             frontContent={
               <div style={{ fontSize: 13, lineHeight: 1.6, color: "var(--text2)", padding: "0 10px" }}>
