    ...
    <div style={{ 
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <h3 style={{ fontFamily: "var(--font-head)", fontSize: 16, color: "var(--blue)", margin: 0 }}>
            {title}
          </h3>
        </div>
        <div style={{ 
      ...
      {open && (
        <div style={{ padding: "16px", borderTop: "1px solid rgba(0,112,192,0.1)" }}>
          {children}
        </div>
      )}
    </div>  );
  ...
  return (
    <div className="page">
      ...
      <div className="card" style={{ borderLeft: "4px solid var(--blue)", marginBottom: 20 }}>
        <div style={{ display: "flex", alignItems: "center", gap: "20px", marginBottom: "20px" }}>
          ...
          <div style={{ flexGrow: 1 }}>
            <h1 style={{ fontFamily: "var(--font-head)", fontSize: 24, color: "var(--blue)", margin: 0 }}>
              {profile.name}
            </h1>
            <div style={{ 
      ...
      <div className="tabs" style={{ marginBottom: 20 }}>
        <button 
          className={`tab ${activeTab === "about" ? "on" : ""}`} 
      ...
      {activeTab === "about" && (
        <div>
          <Accordion title="Астрологический портрет" icon="♈" defaultOpen={true}>
            ...
            <div style={{ 
              ...
              <div style={{ fontSize: 13, lineHeight: 1.5, color: "var(--text2)" }}>
                Твоя стихия наделяет тебя адаптивностью. Слабые зоны — {insights.zodiacWeaknesses || "лёгкие и нервная система"}.
              </div>
            </div>
            <div style={{ 
              padding: 10, 
          ...
          <Accordion title="Восточный знак" icon="🐗">
            ...
            <div style={{ fontSize: 13, lineHeight: 1.5, color: "var(--text2)" }}>
              {insights.eastern} наделяет тебя {insights.easternTraits || "честностью и терпимостью"}. 
              Задача — {insights.easternKarma || "научиться говорить 'нет'"}.
            </div>
          </Accordion>
          ...
          <Accordion title="Хроно-тип" icon="🦉">
            ...
            <div style={{ fontSize: 13, lineHeight: 1.5, color: "var(--text2)" }}>
              {profile.chronotype?.includes("Сова") 
                ? "Пик продуктивности вечером. Утро — для рутины." 
                : "Пик активности в первой половине дня. Вечером энергия падает."}
            </div>
          </Accordion>
        </div>
      )}
          ...
          <div className="card" style={{ marginBottom: 20 }}>
            ...
            <div style={{ fontSize: 14, lineHeight: 1.6, color: "var(--text2)" }}>
              <div style={{ marginBottom: 8 }}>
                <strong>Сейчас:</strong> {moonDay > 25 
                  ? "Завершение лунного месяца" 
                  : moonDay > 15 
                    ? "Убывающая Луна" 
                    : "Растущая Луна"}
              </div>
              ...
              <div>
                <strong>Рекомендация:</strong> {moonDay > 25 
                  ? "Завершай начатое." 
                  : moonDay > 15 
                    ? "Время очищения." 
                    : "Время роста и новых начинаний."}
              </div>
            </div>
          </div>
          <div className="card">
            <LifeCycleSpiral age={age} />
          </div>
        </div>
      )}
