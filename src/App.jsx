...
function getProfDeadlines(profile) {
  ...
  // ════════════════════════════════════════════════════
  //  БУХГАЛТЕР / ИП — КАЗАХСТАН (Налоговый кодекс РК)
  //  Источник: ст.149, 161, 209, 314, 424, 484, 697, 701 НК РК
  // ════════════════════════════════════════════════════
  if(prof.includes("Бухгалтер") || prof.includes("ИП")) {

    // ─── ЯНВАРЬ ──────────────────────────────────────
    tasks.push(mk("🏛 КГД: ФНО 911.00 — Патент (подача/продление)",     1, 5,  "Подать до начала деятельности или продлить на новый год. Уплата налогов — одновременно","КГД"));
    tasks.push(mk("📊 БНС: Форма 1-Т (4 кв.) — Труд и зарплата",       1, 15, "Отчёт за 4 квартал прошлого года — численность и зарплата","БНС"));
    tasks.push(mk("🏛 КГД: ФНО 200.00 — Зарплатный (4 кв.)",           1, 25, "ИПН, ОПВ, ОСМС, СО — за 4 квартал. УПЛАТА тоже до 25 января","КГД"));
    tasks.push(mk("🏛 КГД: ФНО 300.00 — НДС (4 кв.)",                  1, 25, "Декларация по НДС за 4 квартал. УПЛАТА — до 25 января","КГД"));
    tasks.push(mk("🏥 ФСМС: ОСМС взносы (4 кв.)",                      1, 25, "Взносы на медстрахование за 4 квартал — 3% от ФОТ. Уплата до 25-го","ФСМС"));
    tasks.push(mk("🏛 КГД: ФНО 910.00 — Упрощённая декл. (2 п/г)",     1, 25, "СНР: декларация за 2-е полугодие прошлого года. УПЛАТА — до 25 января","КГД"));

    // ─── ФЕВРАЛЬ ─────────────────────────────────────
    tasks.push(mk("🏦 ЕНПФ: Сверка ОПВ за прошлый год",                 2, 1,  "Сверка обязательных пенсионных взносов за прошлый год","ЕНПФ"));
    tasks.push(mk("📊 БНС: Форма 4-Т — Условия труда (год)",            2, 10, "Годовой отчёт об условиях труда работников","БНС"));
    tasks.push(mk("📊 БНС: Форма 1-П (янв.) — Промышленность",          2, 10, "Ежемесячный отчёт за январь (для промышленных предприятий)","БНС"));
    tasks.push(mk("📊 БНС: Форма 2-Т — Трудоустройство (год)",          2, 15, "Движение рабочей силы за прошлый год","БНС"));
    tasks.push(mk("🏛 МФ: Отчёт об исполнении бюджета (год)",           2, 15, "Годовой отчёт в Министерство финансов (для госструктур)","МФ"));
    tasks.push(mk("🔍 КФМ: Отчёт по финмониторингу (год)",              2, 15, "Комитет финансового мониторинга — при наличии обязательства","КФМ"));
    tasks.push(mk("💰 КГД: Аванс налог на имущество/землю (1 срок)",    2, 25, "Первый авансовый платёж — 1/4 от суммы налога за прошлый год","КГД"));

    // ─── МАРТ ────────────────────────────────────────
    tasks.push(mk("📊 БНС: Форма 1-ПФ — Финансы предприятий (год)",     3, 15, "Годовой финансовый отчёт в статистику (баланс, прибыли/убытки)","БНС"));
    tasks.push(mk("🌿 МЭПР: Экологическая отчётность (год)",            3, 20, "Министерство экологии — при наличии природопользования","МЭПР"));
    tasks.push(mk("🏛 КГД: ФНО 100.00 — КПН (год)",                    3, 31, "Корпоративный подоходный налог за прошлый год. УПЛАТА — до 10 апреля","КГД"));
    tasks.push(mk("🏛 КГД: ФНО 220.00 — ИПН (год, ОУР)",               3, 31, "ИП на общеустановленном режиме — декларация по ИПН. УПЛАТА — до 10 апреля","КГД"));
    tasks.push(mk("🏛 КГД: ФНО 240.00 — ИПН физлица (год)",            3, 31, "Физические лица с имущественным доходом. УПЛАТА — до 10 апреля","КГД"));
    tasks.push(mk("🏛 КГД: ФНО 700.00 — Налог на имущество/землю (год)",3, 31, "Декларация по налогу на имущество и земельному налогу. УПЛАТА — до 1 апреля","КГД"));
    tasks.push(mk("🏛 КГД: ФНО 870.00 — Транспортный налог (год)",      3, 31, "Декларация ЮЛ по транспортному налогу. УПЛАТА — до 1 апреля","КГД"));
    tasks.push(mk("🏦 ЕНПФ: ОППВ — профессиональные взносы (год)",      3, 31, "При наличии работников на вредных производствах","ЕНПФ"));
    tasks.push(mk("🔍 АФН: Годовая финансовая отчётность",              3, 31, "Агентство по регулированию финрынка — для финорганизаций","АФН"));
    tasks.push(mk("💰 КГД: Уплата КПН/ИПН за год",                     4, 10, "Срок уплаты налогов по годовым декларациям ФНО 100/220/240","КГД"));

    // ─── АПРЕЛЬ ──────────────────────────────────────
    tasks.push(mk("💰 КГД: Уплата налога на имущество/землю/транспорт", 4, 1,  "Срок уплаты налогов по ФНО 700 и 870 за прошлый год","КГД"));
    tasks.push(mk("📊 БНС: Форма ДАП-ПМ (1 кв.) — Деловая активность", 4, 8,  "Квартальный отчёт для малого бизнеса промышленности","БНС"));
    tasks.push(mk("📊 БНС: Форма 1-П (апр.) — Промышленность",          4, 10, "Ежемесячный отчёт за апрель","БНС"));
    tasks.push(mk("📊 БНС: Форма 1-Т (1 кв.) — Труд и зарплата",        4, 10, "Отчёт за 1 квартал — численность и зарплата","БНС"));
    tasks.push(mk("📊 БНС: Форма 11 — Основные средства (год)",          4, 15, "Годовой отчёт об основных фондах","БНС"));
    tasks.push(mk("📊 БНС: Форма 1-МП — Малый бизнес (год)",             4, 15, "Для субъектов МСБ — годовой отчёт","БНС"));
    tasks.push(mk("🏛 МЮ: Годовой отчёт НКО",                           4, 30, "Некоммерческие организации — отчёт в Министерство юстиции","МЮ"));
    tasks.push(mk("🔍 АПК: Антикоррупционное уведомление (год)",         4, 30, "Агентство по противодействию коррупции — ежегодно","АПК"));
    tasks.push(mk("🏛 КГД: ФНО 200.00 — Зарплатный (1 кв.)",            4, 25, "ИПН, ОПВ, ОСМС, СО — за 1 квартал. УПЛАТА тоже до 25 апреля","КГД"));
    tasks.push(mk("🏛 КГД: ФНО 300.00 — НДС (1 кв.)",                   4, 25, "Декларация по НДС за 1 квартал. УПЛАТА — до 25 апреля","КГД"));
    tasks.push(mk("🏥 ФСМС: ОСМС взносы (1 кв.)",                       4, 25, "Взносы на медстрахование за 1 квартал. Уплата до 25-го","ФСМС"));
    tasks.push(mk("💰 КГД: Аванс по КПН (апрель)",                       4, 25, "Ежемесячный авансовый платёж по КПН — апрель","КГД"));

    // ─── МАЙ ─────────────────────────────────────────
    tasks.push(mk("💰 КГД: Аванс по КПН (май)",                          5, 25, "Ежемесячный авансовый платёж по КПН","КГД"));
    tasks.push(mk("💰 КГД: Аванс налог на имущество/землю (2 срок)",     5, 25, "Второй авансовый платёж — 1/4 от суммы налога","КГД"));
    tasks.push(mk("🏛 КГД: ФНО 150.00 — Трансфертное ценообразование",   5, 31, "При наличии контролируемых сделок с нерезидентами","КГД"));

    // ─── ИЮНЬ ────────────────────────────────────────
    tasks.push(mk("📋 Годовое собрание участников ТОО / акционеров АО",  6, 30, "Обязательно проводится не позднее 6 месяцев после конца финансового года","МЮ"));
    tasks.push(mk("💰 КГД: Аванс по КПН (июнь)",                          6, 25, "Ежемесячный авансовый платёж по КПН","КГД"));

    // ─── ИЮЛЬ ────────────────────────────────────────
    tasks.push(mk("📊 БНС: Форма 1-П (июл.) — Промышленность",            7, 10, "Ежемесячный отчёт за июль","БНС"));
    tasks.push(mk("📊 БНС: Форма 1-Т (2 кв.) — Труд и зарплата",          7, 10, "Отчёт за 2 квартал","БНС"));
    tasks.push(mk("🏛 КГД: ФНО 200.00 — Зарплатный (2 кв.)",              7, 25, "ИПН, ОПВ, ОСМС, СО — за 2 квартал. УПЛАТА тоже до 25 июля","КГД"));
    tasks.push(mk("🏛 КГД: ФНО 300.00 — НДС (2 кв.)",                     7, 25, "Декларация по НДС за 2 квартал. УПЛАТА — до 25 июля","КГД"));
    tasks.push(mk("🏥 ФСМС: ОСМС взносы (2 кв.)",                         7, 25, "Взносы на медстрахование за 2 квартал. Уплата до 25-го","ФСМС"));
    tasks.push(mk("💰 КГД: Аванс по КПН (июль)",                           7, 25, "Ежемесячный авансовый платёж по КПН","КГД"));

    // ─── АВГУСТ ──────────────────────────────────────
    tasks.push(mk("🏛 КГД: ФНО 910.00 — Упрощённая декл. (1 п/г)",       8, 15, "СНР: декларация за 1-е полугодие текущего года. УПЛАТА — до 25 августа","КГД"));
    tasks.push(mk("📊 БНС: Форма 1-П (авг.) — Промышленность",            8, 10, "Ежемесячный отчёт за август","БНС"));
    tasks.push(mk("💰 КГД: Аванс по КПН (август)",                         8, 25, "Ежемесячный авансовый платёж по КПН","КГД"));
    tasks.push(mk("💰 КГД: Аванс налог на имущество/землю (3 срок)",       8, 25, "Третий авансовый платёж — 1/4 от суммы налога","КГД"));
    tasks.push(mk("💰 КГД: Уплата по ФНО 910.00 (1 п/г)",                 8, 25, "Уплата налогов по упрощённой декларации за 1-е полугодие","КГД"));

    // ─── СЕНТЯБРЬ ────────────────────────────────────
    tasks.push(mk("📋 Воинский учёт — годовая сверка",                     9, 1,  "Ежегодная сверка списков с местным военкоматом (ВЦУ)","HR"));
    tasks.push(mk("💰 КГД: Аванс по КПН (сентябрь)",                       9, 25, "Ежемесячный авансовый платёж по КПН","КГД"));

    // ─── ОКТЯБРЬ ─────────────────────────────────────
    tasks.push(mk("📊 БНС: Форма 1-П (окт.) — Промышленность",            10, 10, "Ежемесячный отчёт за октябрь","БНС"));
    tasks.push(mk("📊 БНС: Форма 1-Т (3 кв.) — Труд и зарплата",          10, 10, "Отчёт за 3 квартал","БНС"));
    tasks.push(mk("🏛 КГД: ФНО 200.00 — Зарплатный (3 кв.)",              10, 25, "ИПН, ОПВ, ОСМС, СО — за 3 квартал. УПЛАТА тоже до 25 октября","КГД"));
    tasks.push(mk("🏛 КГД: ФНО 300.00 — НДС (3 кв.)",                     10, 25, "Декларация по НДС за 3 квартал. УПЛАТА — до 25 октября","КГД"));
    tasks.push(mk("🏥 ФСМС: ОСМС взносы (3 кв.)",                         10, 25, "Взносы на медстрахование за 3 квартал. Уплата до 25-го","ФСМС"));
    tasks.push(mk("💰 КГД: Аванс по КПН (октябрь)",                        10, 25, "Ежемесячный авансовый платёж по КПН","КГД"));

    // ─── НОЯБРЬ ──────────────────────────────────────
    tasks.push(mk("💰 КГД: Аванс налог на имущество/землю (4 срок)",      11, 25, "Четвёртый (последний) авансовый платёж","КГД"));
    tasks.push(mk("💰 КГД: Аванс по КПН (ноябрь)",                        11, 25, "Ежемесячный авансовый платёж по КПН","КГД"));
    tasks.push(mk("📊 БНС: Форма 1-П (ноябрь) — Промышленность",         11, 10, "Ежемесячный отчёт за ноябрь","БНС"));

    // ─── ДЕКАБРЬ ─────────────────────────────────────
    tasks.push(mk("🏛 КГД: Продление/получение лицензий",                 12,  1, "Проверить сроки действия всех лицензий и разрешений","КГД"));
    tasks.push(mk("📋 График отпусков на следующий год",                   12, 15, "Утвердить до 15 декабря включительно","HR"));
    tasks.push(mk("💰 КГД: Аванс по КПН (декабрь)",                       12, 25, "Ежемесячный авансовый платёж по КПН","КГД"));
  }
