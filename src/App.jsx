  ...
  return (
    ...
    >
      ...
      <div style={{
        position:'absolute', inset:0,
        background: isToday
          ? 'linear-gradient(135deg, rgba(10,37,64,0.86) 0%, rgba(30,58,95,0.68) 100%)'
      ...
      <div style={{ position:'absolute', top:7, left:7, width:11, height:11,
        borderTop:`2px solid ${C.gold}`, borderLeft:`2px solid ${C.gold}`, opacity:0.75 }} />
      <div style={{ position:'absolute', bottom:7, right:7, width:11, height:11,
        borderBottom:`2px solid ${C.gold}`, borderRight:`2px solid ${C.gold}`, opacity:0.75 }} />
        ...
        <div style={{
          ...
          <div>
            <div style={{
              ...
              fontFamily:"'JetBrains Mono',monospace",
              textTransform:'uppercase', letterSpacing:3, marginBottom:5, opacity:0.9,
            }}>Сегодня</div>
            <div style={{
            ...
            <div style={{
              fontSize:13, color:C.goldPale, marginTop:4, opacity:0.85,
          ...
          <div style={{
            ...
            textShadow:`0 2px 16px rgba(212,175,55,0.50)`,
          }}>{time}</div>
        </div>
      )}
        ...
        <div style={{ maxWidth:960, margin:'0 auto', padding:'20px 24px 48px' }}>
          <div style={{
            ...
            <div style={{ flex:1, height:1,
              background:`linear-gradient(90deg, transparent, ${C.navy})`, opacity:0.12 }} />
            <div style={{ fontFamily:"'JetBrains Mono',monospace",
              fontSize:9, letterSpacing:3.5, color:C.text3, textTransform:'uppercase' }}>Разделы</div>
            <div style={{ flex:1, height:1,
              background:`linear-gradient(90deg, ${C.navy}, transparent)`, opacity:0.12 }} />
          </div>

          {/* Сетка: на мобиле 2 col, на ПК 4 col */}
          <div style={{
            display:'grid',
    ...
    <div style={{ minHeight:'100vh', ...bgGrid, display:'flex', flexDirection:'column' }}>
      ...
      <div style={{
        ...
        <div style={{ position:'relative', height:90, overflow:'hidden' }}>
          ...
          {/* Навигация — центрирована с max-width */}
