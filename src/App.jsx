...
.ai-list-body { flex:1; min-width:0; padding-top:2px; }
...
@media(max-width:380px) {
  .ai-list-item { padding:12px 14px; gap:10px; }
  .ai-list-num { width:26px; height:26px; font-size:12px; }
            ...
            {b.items.map((item, j) => {
              ...
              return <div key={j} className="ai-list-item">
                ...
                <div className="ai-list-body">
                  ...
                  <div className="ai-list-text">{body}</div>
                </div>
              </div>;
            })}
          </div>;
