...
const ORGAN_REGIONS = [
  ...
  { id: 3, name: 'Желудок', time: '07:00-09:00', desc: 'Пищеварение, усвоение нутриентов, энергия.', path: 'M120,290 C140,280 170,290 180,320 C190,350 170,380 140,390 C110,400 100,370 120,340 C130,320 110,300 120,290 Z' },
  ...
  { id: 5, name: 'Сердце', time: '11:00-13:00', desc: 'Циркуляция, радость, ясность сознания.', path: 'M160,180 C150,200 160,240 190,250 C220,240 230,200 200,180 C190,170 170,170 160,180 Z' },
  ...
  { id: 8, name: 'Почки', time: '17:00-19:00', desc: 'Ресурс, страхи, кости, мозговая функция.', path: 'M100,290 C90,310 90,340 110,350 C130,360 140,330 130,300 C120,280 110,280 100,290 Z M300,290 C310,310 310,340 290,350 C270,360 260,330 270,300 C280,280 290,280 300,290 Z' },
  { id: 9, name: 'Перикард', time: '19:00-21:00', desc: 'Защита сердца, эмоции, романтика.', path: 'M170,190 C160,210 170,250 200,260 C230,250 240,210 230,190 C220,180 180,180 170,190 Z' },
  { id: 10, name: '3 Обогревателя (верх)', time: '21:00-23:00', desc: 'Распределение тепла, регуляция систем.', path: 'M180,110 C170,130 180,160 200,170 C220,160 230,130 220,110 C210,100 190,100 180,110 Z' },
  { id: 11, name: '3 Обогревателя (низ)', time: '23:00-01:00', desc: 'Сброс ритмов, глубокий покой, сон.', path: 'M180,320 C170,340 180,370 200,380 C220,370 230,340 220,320 C210,310 190,310 180,320 Z' },
