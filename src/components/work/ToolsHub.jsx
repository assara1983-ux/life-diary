...
const TOOL_DESCRIPTIONS = {
  ...
  regimes:  { desc:'Сравнение налоговых режимов: ОУР, УНР, Патент, СНР. Расчёт оптимального режима.', steps:['Введите доход и расходы','Выберите вид деятельности','Сравните налоговую нагрузку'] },
